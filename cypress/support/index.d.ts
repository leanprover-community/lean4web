...
declare namespace Cypress {
    ...
    type ContainsAllOptions = Partial<Loggable & Timeoutable & CaseMatchable & Shadow>
    type ContainsAllFn = CommandFnWithSubject<"containsAll", void | JQueryWithSelector<HTMLElement>>
    interface Chainable<Subject> {
        ...
        containsAll(contents: (string | number | RegExp)[], options?: ContainsAllOptions): Chainable<Subject>
